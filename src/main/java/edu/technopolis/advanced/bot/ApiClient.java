...
class ApiClient implements Closeable {
    protected static final Logger log = LoggerFactory.getLogger(ApiClient.class);
    protected static final ObjectMapper MAPPER = new ObjectMapper();

    protected final String apiSchema;
    protected final String apiHost;
    protected final String tokenParam;
    ...
    ApiClient(String apiSchema, String apiHost, String tokenParam) {
        ...
        client = HttpClients.custom()
                .setDefaultHeaders(Arrays.asList(
                        ...
                        new BasicHeader("Agent", "bot-bot"),
                        new BasicHeader("Accept", "*/*"),
                        new BasicHeader("Access-Control-Allow-Origin", "*"),
                        new BasicHeader("Access-Control-Allow-Methods", "POST, PUT, DELETE, HEAD, PATCH, OPTIONS")
                        )
                ).build();
    ...
    protected  <REQ extends Request> String getQueryString(REQ req) {
